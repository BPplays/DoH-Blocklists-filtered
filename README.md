...
the folders used:  
  * `./full`: (updated every day) list of domains from the full dibdot list and all parts of the mini list  
  * `./mini`: (updated every 3 hours) list made by me, from some common ones and all DoH servers chromium will use  
